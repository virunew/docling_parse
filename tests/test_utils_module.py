...
class TestUtilsModule(unittest.TestCase):
    """Test case for utils module functions."""
    ...
    def setUp(self):
        ...
        # Define the expected output after removing base64 data
    ...
    def test_remove_base64_data(self):
        ...
        # Assert that the original data remains unchanged
        self.assertIn("data:image/png;base64,", self.test_data["simple_string"])
    
    def test_remove_base64_nested_dict(self):
    ...
    def test_remove_base64_list(self):
        """Test removing base64 from a list."""
        test_list = self.test_data["list_with_images"]
        result = remove_base64_data(test_list)
        
        self.assertEqual(result[0], "[BASE64_IMAGE_DATA_REMOVED]")
        self.assertEqual(result[1], "No base64 here")
        self.assertEqual(result[2]["another_image"], "[BASE64_IMAGE_DATA_REMOVED]")
    
    def test_remove_base64_deep_nested(self):
